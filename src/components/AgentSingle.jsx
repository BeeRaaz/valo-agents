    ...
    <section className="py-32 md:relative md:min-h-screen md:flex md:flex-wrap md:items-center">
      <div className="md:absolute md:inset-0 md:-z-[1]">
        <img
          ...
          className="w-full h-full object-cover object-center md:object-left-top lg:object-center-top lg:object-contain"
        />
      </div>
      <div className="container">
        <div className="py-20 md:py-32">
          <div className="intro md:max-w-96">
          ...
          <div className="abilities md:max-w-96 lg:ms-auto">
            ...
            <ul className="list-none text-white-100 flex flex-wrap gap-5">
              {agent.abilities.map((ability) => {
                return (
                  ...
                  >
                    <div className="w-full max-w-24 mx-auto mb-5">
                      <img
